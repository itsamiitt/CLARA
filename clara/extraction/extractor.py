...
# Re-exported: `from clara.extraction.extractor import ExtractedFact` is
# established API. The definitions live in the light types module so that
# importing them does not pull the OpenAI SDK.
from clara.extraction.types import ExtractedFact, ExtractionResult  # noqa: F401
